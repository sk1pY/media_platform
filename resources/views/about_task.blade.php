                ...
                @foreach($comments as $comment)
                    <div class="row mb-3">
                        <div class="col-12 d-flex">
                            <img src="{{ Storage::url($comment->user->image) }}" class="rounded-circle" style="width: 50px; height: 50px;" alt="...">
                            <div class="ms-2">
                                <div class="fw-bold">{{ $comment->user->name }}</div>
                                <small class="text-muted mb-0">{{ $comment->created_at->diffForHumans() }}</small>
                            </div>
                        </div>
