            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    @if(Auth()->user()->email_verified_at)
                        <span class="ms-2 badge text-bg-success">Email подтвержден</span>
                    @else
                        <span class="ms-2 badge text-bg-warning">Email не подтвержден
                ...
                <div class="m-0 p-0 d-flex flex-column gap-2 mt-3">
                    @can('admin_panel')
                    <a href="{{ route('admin.index') }}" class="btn btn-light border-danger bg-danger text-white">Админ панель</a>
                    @endcan
