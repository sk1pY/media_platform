    ...
    <div class="card-body">
        <div class="row align-items-center ">
            ...
            @auth
                <div class="col-auto d-flex">
                    ...
                    <div class="dropdown" style="position: relative; z-index: 1050;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a data-bs-toggle="modal" data-bs-target="#complain-post" class="dropdown-item"
                ...
                {{-- MODAL WINDOW --}}
                <div class="modal fade" id="complain-post" tabindex="-1" aria-labelledby="complainModalLabel"
                    aria-hidden="true">
        ...
        <div class="mt-3 mb-2">
            <a href="{{ route('posts.show', $post->id) }}" class="text-decoration-none text-dark hover-effect fs-4 ">
                {{ $post->title }}
            </a>
        </div>
